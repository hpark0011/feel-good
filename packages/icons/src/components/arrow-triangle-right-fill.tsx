...
export const ArrowTriangleRightFillIcon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
  ({ className, ...props }, ref) => (
    <svg
      ref={ref}
      viewBox="0 0 28 28"
...
ArrowTriangleRightFillIcon.displayName = "ArrowTriangleRightFillIcon";
