...
const cspDirectives = [
  ...
  "connect-src 'self' https://*.convex.cloud wss://*.convex.cloud https://*.ingest.us.sentry.io https://*.daily.co wss://*.daily.co https://tavusapi.com", // Convex real-time backend + Sentry telemetry + Daily.co + Tavus API
