...
import { LineDownTrendIcon, LineUpTrendIcon } from "@/icons";
import { Icon } from "@/components/ui/icon";

export default function InsightsPage() {
  return (
    <div className='flex flex-col max-w-3xl mx-auto w-full'>
      <h1 className='text-2xl font-medium w-full flex items-center justify-center mb-12'>
        Good afternoon, Han
      </h1>

      <div className='py-3.5 pt-3 px-5 border border-light rounded-3xl gap-8 flex flex-col w-full'>
