...
7. **Validate the ticket.** Read the written file back and check every field against the frontmatter contract. Report any violations and fix them before reporting success.
