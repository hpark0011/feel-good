...
7. **Validate the ticket.** The validation hook runs automatically after writing. If it reports errors, fix them and re-save. Then read the file back for a final human-readable check.
