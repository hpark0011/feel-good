...
You inspect this monorepo to answer: how is the topic currently implemented here, or is it absent? Your output feeds a gap analysis against external best practices.

## Input

- **Topic**: {{feature or pattern}}
