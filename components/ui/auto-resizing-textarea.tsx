...
function AutoResizingTextarea({
  ...
  return (
    <textarea
      className={cn(
        "flex min-h-[40px] w-full rounded-md border bg-background px-3 py-2 text-sm placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 resize-none overflow-hidden caret-blue-300",
        className
      )}
