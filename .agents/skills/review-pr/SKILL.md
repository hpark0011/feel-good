...
5. **Incorrect / disagree** — The suggestion would introduce a bug, conflicts with project conventions (check AGENTS.md and .Codex/rules/), or is based on a misunderstanding of the code.

Use `git diff main...HEAD` and the current file contents to make this assessment — do not guess from the comment text alone.
